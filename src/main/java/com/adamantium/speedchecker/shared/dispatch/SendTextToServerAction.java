...
package com.adamantium.speedchecker.shared.dispatch;

import com.gwtplatform.dispatch.shared.DispatchAsync;
import com.gwtplatform.dispatch.shared.UnsecuredActionImpl;

/**
 * Экшин, который вызывается при помощи {@link DispatchAsync} (на стороне клиента) к класу
 * {@link com.gwtplatform.dispatch.server.Dispatch} (на стороне сервера).
 */
